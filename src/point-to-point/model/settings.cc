...
uint64_t Settings::dcp_retrans_bytes = 0;
uint64_t Settings::dcp_retrans_from_ho = 0;
uint64_t Settings::dcp_retrans_from_timeout = 0;
uint64_t Settings::dcp_retrans_retrimmed = 0;
...
uint64_t Settings::ar_packets = 0;
uint64_t Settings::ar_path_switches = 0;
uint64_t Settings::ar_used_next_hops = 0;
uint64_t Settings::irn_ooo_packets = 0;
uint64_t Settings::irn_nack_packets = 0;
...
uint32_t Settings::dcp_retrans_batch_size = 1;
uint32_t Settings::dcp_retrans_quota_bytes = 0;
bool Settings::dcp_retrans_respect_win = false;
